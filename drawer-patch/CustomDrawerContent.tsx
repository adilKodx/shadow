...
const NAV_ITEMS: NavItem[] = [
  ...
  { route: 'Chat', label: 'Chat', icon: 'chatbubble-outline', badge: 3 },
  { route: 'Notifications', label: 'Notifications', icon: 'notifications-outline', badge: 12 },
  { route: 'News', label: 'News', icon: 'newspaper-outline' },
  { route: 'Alerts', label: 'Alerts', icon: 'warning-outline', badge: 2, severity: 'critical' },
  { route: 'Incidents', label: 'Incidents', icon: 'document-text-outline' },
  { route: 'SOPs', label: 'SOPs', icon: 'clipboard-outline' },
  { route: 'Map', label: 'Live Map', icon: 'map-outline' },
  { route: 'POI', label: 'POI Database', icon: 'person-outline' },
  { route: 'Team', label: 'Team', icon: 'people-outline' },
    ...
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      ...
      <View style={styles.footer}>
        ...
        <View style={{ alignItems: 'center', marginTop: 10 }}>
          <MonoLabel color={colors.textMute}>SHADOWFIELD · v1.0.0 · BUILD 247</MonoLabel>
        </View>
      </View>
    </SafeAreaView>
  );
