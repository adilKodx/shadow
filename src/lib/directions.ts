...
function resolveToken(explicit?: string): string {
  ...
  // Vite statically replaces this literal at build time — it must be written
  // exactly as `import.meta.env.VITE_MAPBOX_ACCESS_TOKEN` (no dynamic access).
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  const viteToken = (import.meta as any).env?.VITE_MAPBOX_ACCESS_TOKEN as string | undefined;
